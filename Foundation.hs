...
data App = App
    { settings :: AppConfig DefaultEnv Extra, getStatic :: Static, httpManager :: Manager, appLogger :: Logger }
...
instance Yesod App where
    ...
    defaultLayout widget = do
        ...
        pc <- widgetToPageContent $ do
            ...
            addStylesheet $ StaticR css_ripples_min_css
            addScript $ StaticR js_jquery_min_js
            addScript $ StaticR js_angular_min_js
            addScript $ StaticR js_bootstrap_min_js
            addScript $ StaticR js_material_min_js
            addScript $ StaticR js_ripples_min_js
